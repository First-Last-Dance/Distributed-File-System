...
const (
	DataKeeperOpenConnectionService_DataKeeperOpenConnection_FullMethodName = "/master.DataKeeperOpenConnectionService/DataKeeperOpenConnection"
)

// DataKeeperOpenConnectionServiceClient is the client API for DataKeeperOpenConnectionService service.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://pkg.go.dev/google.golang.org/grpc/?tab=doc#ClientConn.NewStream.
type DataKeeperOpenConnectionServiceClient interface {
	DataKeeperOpenConnection(ctx context.Context, in *DataKeeperOpenConnectionRequest, opts ...grpc.CallOption) (*DataKeeperOpenConnectionResponse, error)
}

type dataKeeperOpenConnectionServiceClient struct {
	cc grpc.ClientConnInterface
}

func NewDataKeeperOpenConnectionServiceClient(cc grpc.ClientConnInterface) DataKeeperOpenConnectionServiceClient {
	return &dataKeeperOpenConnectionServiceClient{cc}
}

func (c *dataKeeperOpenConnectionServiceClient) DataKeeperOpenConnection(ctx context.Context, in *DataKeeperOpenConnectionRequest, opts ...grpc.CallOption) (*DataKeeperOpenConnectionResponse, error) {
	out := new(DataKeeperOpenConnectionResponse)
	err := c.cc.Invoke(ctx, DataKeeperOpenConnectionService_DataKeeperOpenConnection_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// DataKeeperOpenConnectionServiceServer is the server API for DataKeeperOpenConnectionService service.
// All implementations must embed UnimplementedDataKeeperOpenConnectionServiceServer
// for forward compatibility
type DataKeeperOpenConnectionServiceServer interface {
	DataKeeperOpenConnection(context.Context, *DataKeeperOpenConnectionRequest) (*DataKeeperOpenConnectionResponse, error)
	mustEmbedUnimplementedDataKeeperOpenConnectionServiceServer()
}

// UnimplementedDataKeeperOpenConnectionServiceServer must be embedded to have forward compatible implementations.
type UnimplementedDataKeeperOpenConnectionServiceServer struct {
}

func (UnimplementedDataKeeperOpenConnectionServiceServer) DataKeeperOpenConnection(context.Context, *DataKeeperOpenConnectionRequest) (*DataKeeperOpenConnectionResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DataKeeperOpenConnection not implemented")
}
func (UnimplementedDataKeeperOpenConnectionServiceServer) mustEmbedUnimplementedDataKeeperOpenConnectionServiceServer() {
}

// UnsafeDataKeeperOpenConnectionServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to DataKeeperOpenConnectionServiceServer will
// result in compilation errors.
type UnsafeDataKeeperOpenConnectionServiceServer interface {
	mustEmbedUnimplementedDataKeeperOpenConnectionServiceServer()
}

func RegisterDataKeeperOpenConnectionServiceServer(s grpc.ServiceRegistrar, srv DataKeeperOpenConnectionServiceServer) {
	s.RegisterService(&DataKeeperOpenConnectionService_ServiceDesc, srv)
}

func _DataKeeperOpenConnectionService_DataKeeperOpenConnection_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DataKeeperOpenConnectionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DataKeeperOpenConnectionServiceServer).DataKeeperOpenConnection(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataKeeperOpenConnectionService_DataKeeperOpenConnection_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DataKeeperOpenConnectionServiceServer).DataKeeperOpenConnection(ctx, req.(*DataKeeperOpenConnectionRequest))
	}
	return interceptor(ctx, in, info, handler)
}

// DataKeeperOpenConnectionService_ServiceDesc is the grpc.ServiceDesc for DataKeeperOpenConnectionService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var DataKeeperOpenConnectionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "master.DataKeeperOpenConnectionService",
	HandlerType: (*DataKeeperOpenConnectionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "DataKeeperOpenConnection",
			Handler:    _DataKeeperOpenConnectionService_DataKeeperOpenConnection_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "gRPC/master.proto",
