...
const (
	TextService_Capitalize_FullMethodName = "/capitalize.TextService/Capitalize"
	TextService_Request_FullMethodName    = "/capitalize.TextService/Request"
)
...
type TextServiceClient interface {
	...
	Request(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadResponse, error)
}
...
func (c *textServiceClient) Request(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadResponse, error) {
	out := new(UploadResponse)
	err := c.cc.Invoke(ctx, TextService_Request_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TextServiceServer interface {
	...
	Request(context.Context, *UploadRequest) (*UploadResponse, error)
...
func (UnimplementedTextServiceServer) Request(context.Context, *UploadRequest) (*UploadResponse, error) {
...
func _TextService_Request_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UploadRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TextServiceServer).Request(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TextService_Request_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TextServiceServer).Request(ctx, req.(*UploadRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TextService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Request",
			Handler:    _TextService_Request_Handler,
		},
	},
